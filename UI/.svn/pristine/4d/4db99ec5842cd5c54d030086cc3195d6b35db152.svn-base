...
namespace Util
{
  ...
  /// 
  /// CODE FROM http://www.scottlogic.com/blog/2010/07/21/exposing-and-binding-to-a-silverlight-scrollviewers-scrollbars.html
  /// 
  /// </summary>
  public static class ScrollViewerBinding
  {
    ...
    public static readonly DependencyProperty VerticalOffsetProperty =
        ...
        typeof(ScrollViewerBinding), new PropertyMetadata(-1.0, OnVerticalOffsetPropertyChanged));
